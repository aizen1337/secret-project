...
import { RenterVerificationCard } from "@/features/profile/ui/RenterVerificationCard";
  ...
  return (
    <SafeAreaView className="flex-1 bg-background">
      <View className="px-4 py-3 border-b border-border flex-row items-center">
        ...
        <Text className="ml-3 text-lg font-semibold text-foreground">{t("profile.menu.privacy")}</Text>
      </View>

      <ScrollView className="flex-1" contentContainerStyle={{ padding: 16, paddingBottom: 32 }}>
        <RenterVerificationCard />
      </ScrollView>
    </SafeAreaView>
  );
}
