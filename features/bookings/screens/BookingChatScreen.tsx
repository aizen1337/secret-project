...
export default function BookingChatScreen() {
  ...
  const sendBookingMessage = useMutation(bookingsApi.bookingChat.sendBookingMessage);
  const markBookingChatRead = useMutation(bookingsApi.bookingChat.markBookingChatRead);
  const generateBookingChatImageUploadUrl = useMutation(bookingsApi.bookingChat.generateBookingChatImageUploadUrl);
