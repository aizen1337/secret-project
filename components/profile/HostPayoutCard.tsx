...
export function HostPayoutCard({ connect }: HostPayoutCardProps) {
  ...
  const createHostOnboardingLink = useAction(api.stripeConnect.createHostOnboardingLink);
  const refreshHostConnectStatus = useAction(api.stripeConnect.refreshHostConnectStatus);
