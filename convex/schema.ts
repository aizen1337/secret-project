...
export default defineSchema({
  users: defineTable({
    ...
    onboardingRole: v.optional(v.union(v.literal("renter"), v.literal("host"), v.literal("both"))),
    onboardingStatus: v.optional(
      v.union(v.literal("in_progress"), v.literal("skipped"), v.literal("completed")),
    ),
    onboardingSource: v.optional(v.literal("signup")),
  ...
  bookings: defineTable({
    ...
    collectionLockboxInstructions: v.optional(v.string()),
    collectionDeliveryInstructions: v.optional(v.string()),
    hostCollectionConfirmedAt: v.optional(v.number()),
    renterCollectionConfirmedAt: v.optional(v.number()),
    tripStartedAt: v.optional(v.number()),
